...
This repository contains the solution for the Project 3 of the Deep Reinforcement Learning Nano Degree from Udacity. This document contains the report for the Project 3 of the Deep Reinforcement Learning Nano Degree from Udacity. The goal of this project is to train an reinforcement learning agent for a multi-agent collaborative problem.
